...
An Interview Question created from a reviewed Submission and explicitly published by a Moderator in its Track's community collection. It keeps a publication-time snapshot of its contributor username and can be promoted permanently into the public catalogue after reaching the configured unique-Account Like threshold; promotion does not create a second Interview Question.
