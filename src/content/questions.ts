...
Navigator.of(context).pop();`,
  ...
  },
  {
    ...
    difficulty: "Mid",
    question: "إيه حدود presentation وdomain وdata layers؟",
    shortAnswer: "presentation تنسق UI، وdomain تصف قواعد وuse cases، وdata تتعامل مع مصادر مثل HTTP أو database؛ الحدود تقلل تسريب التفاصيل.",
    explanation: "ليست كل التطبيقات تحتاج domain layer كاملة. أضفها عندما توجد قواعد مستقلة أو أكثر من consumer، وخلّي DTO mapping داخل data بدل نشر JSON types إلى UI.",
    commonMistakes: ["نسخ نفس model في كل طبقة بلا اختلاف عقد.", "إجبار feature بسيطة على use-case class لكل function."],
    followUpQuestions: ["متى يكفي presentation وdata من غير domain منفصلة؟"],
    sources: [{ title: "Flutter docs — Architecture case study", url: "https://docs.flutter.dev/app-architecture/case-study" }],
    lastReviewedAt: "2026-08-30",
  },
  {
    id: "arch-004",
    slug: "dependency-injection-in-flutter",
    trackId: "flutter",
    topicIds: ["architecture"],
    difficulty: "Mid",
    question: "إزاي تستخدم dependency injection في Flutter؟",
    shortAnswer: "مرّر dependencies عبر constructor أو composition root، بحيث يمكن تبديلها بـfake أو implementation أخرى من غير تعديل المستهلك.",
    explanation: "حقن dependency يجعل ownership والاختبارات واضحين. اختَر constructor injection في أغلب الحالات، واستخدم container فقط عندما يقلل wiring المتكرر فعلًا؛ الإخفاء الكامل للتبعيات يصعّب القراءة.",
    codeExample: `class UserPresenter {
  UserPresenter(this.repository);
  final UserRepository repository;
}`,
    commonMistakes: ["إنشاء dependency داخل class ثم محاولة mockها لاحقًا.", "تمرير service locator إلى كل method بدل contract واضح."],
    followUpQuestions: ["كيف تختبر presenter من غير network حقيقي؟"],
    sources: [{ title: "Flutter docs — App architecture guide", url: "https://docs.flutter.dev/app-architecture/guide" }],
    lastReviewedAt: "2026-08-30",
  },
  {
    id: "arch-007",
    ...
    explanation: "اختبار unit للـuse case أو repository fake قد يعطي feedback أسرع، مع widget أو integration tests للتكامل الحقيقي. لا تبنِ seam فقط لإرضاء coverage رقمية؛ اختبر المخاطر التي تهم المستخدم.",
    commonMistakes: ["اختبار private methods بدل observable behavior.", "ربط كل test بـmock كثيف ينهار مع refactor بسيط."],
    followUpQuestions: ["متى تكون integration test أفضل من fake؟"],
    sources: [{ title: "Flutter docs — Testing architecture", url: "https://docs.flutter.dev/app-architecture/case-study/testing" }],
    lastReviewedAt: "2026-08-30",
  },
  {
    id: "arch-008",
    slug: "feature-boundaries-and-folder-organization",
    trackId: "flutter",
    topicIds: ["architecture"],
    difficulty: "Junior",
    question: "إزاي تنظّم حدود الـfeature من غير ما تخلي architecture مجرد folders؟",
    shortAnswer: "اجعل حدود كل feature وواجهاتها واضحة، وأضف use cases أو تقسيم presentation وdata فقط عندما تبررها مسؤوليات مختلفة.",
    explanation: "التنظيم وسيلة لا architecture كاملة. اختر شكلًا يجعل ownership واكتشاف الكود واضحين، واربطه باتجاه dependencies وعقود قابلة للاختبار بدل الاعتماد على أسماء المجلدات وحدها.",
    commonMistakes: ["نسخ نفس folder tree لكل feature بلا محتوى.", "اعتبار folder naming دليلًا على فصل dependencies."],
    followUpQuestions: ["ما الذي يجعل folder boundary حقيقية وليست مجرد إعادة تسمية؟"],
    sources: [{ title: "Flutter docs — App architecture guide", url: "https://docs.flutter.dev/app-architecture/guide" }],
    lastReviewedAt: "2026-08-30",
  },
  {
    id: "test-001",
    slug: "unit-tests-for-flutter-domain-logic",
    trackId: "flutter",
    topicIds: ["testing"],
    difficulty: "Junior",
    question: "إيه الذي يميز unit test في مشروع Flutter؟",
    shortAnswer: "unit test يختبر function أو class معزولًا بسرعة، ويكون مناسبًا لقواعد المجال والتحويلات من غير تشغيل Flutter engine أو UI.",
    explanation: "اختبر input وoutput والسلوك المتوقع، وحقن I/O بدل استدعاء network أو disk حقيقي. unit test لا يثبت أن Widgets اتصلت ببعضها؛ لذلك أضف نوع اختبار أعلى عندما تكون المشكلة في التكامل.",
    commonMistakes: ["اختبار implementation الداخلية بدل contract.", "ربط unit test بوقت أو network حقيقي فيصبح بطيئًا ومتذبذبًا."],
    followUpQuestions: ["متى تحتاج widget test بدل unit test؟"],
    sources: [{ title: "Flutter docs — Unit testing", url: "https://docs.flutter.dev/cookbook/testing/unit/introduction" }],
    lastReviewedAt: "2026-08-30",
  },
  {
    id: "test-002",
    slug: "widget-tests-and-user-visible-behavior",
    trackId: "flutter",
    topicIds: ["testing"],
    difficulty: "Junior",
    question: "متى تستخدم widget test في Flutter؟",
    shortAnswer: "widget test يشغّل جزءًا من شجرة Widgets ويقيس السلوك المرئي والتفاعل مع fake dependencies بسرعة معقولة.",
    explanation: "ابحث عن النص أو semantics وتفاعل كما يفعل المستخدم، ثم تحقّق من النتيجة. لا تجعل الاختبار يعتمد على تفاصيل layout أو عدد children إلا إذا كانت جزءًا من contract.",
    commonMistakes: ["تثبيت golden أو private widget structure بدل observable behavior.", "إدخال network حقيقي في widget test."],
    followUpQuestions: ["كيف تختبر loading ثم success في widget؟"],
    sources: [{ title: "Flutter docs — Widget testing", url: "https://docs.flutter.dev/cookbook/testing/widget/introduction" }],
    lastReviewedAt: "2026-08-30",
  },
  {
    id: "test-003",
    slug: "integration-tests-for-critical-flows",
    trackId: "flutter",
    topicIds: ["testing"],
    difficulty: "Mid",
    question: "إيه دور integration test ومتى يستحق تكلفته؟",
    shortAnswer: "integration test يتحقق من flow كامل عبر التطبيق والمنصة مثل تسجيل الدخول أو الدفع، لكنه أبطأ وأكثر اعتمادًا على environment.",
    explanation: "استخدمه للمخاطر التي لا تكشفها unit أو widget tests، وحدد بيانات test وحالة الجهاز بوضوح. لا تحوّل كل assertion إلى integration؛ احتفظ بمعظم feedback في اختبارات أسرع.",
    commonMistakes: ["تشغيل integration suite لكل تغيير صغير.", "ترك backend أو device state غير محدد فيؤدي إلى نتائج متذبذبة."],
    followUpQuestions: ["كيف تقلل زمن integration suite من غير حذف التغطية المهمة؟"],
    sources: [{ title: "Flutter docs — Integration testing", url: "https://docs.flutter.dev/cookbook/testing/integration/introduction" }],
    lastReviewedAt: "2026-08-30",
  },
  {
    id: "test-004",
    slug: "fakes-mocks-and-test-doubles",
    trackId: "flutter",
    topicIds: ["testing"],
    difficulty: "Mid",
    question: "إيه الفرق العملي بين fake وmock وstub في اختبارات Flutter؟",
    shortAnswer: "test double يستبدل dependency؛ fake implementation بسيطة تعمل، وstub يعيد إجابات محددة، وmock يتحقق من تفاعلات متوقعة.",
    explanation: "اختر أبسط double يثبت السلوك المطلوب. fake repository غالبًا أمتن من توقع عشرات calls، وmock مفيد عندما يكون التفاعل نفسه contract مهمًا؛ لا تختبر تفاصيل لا تهم المستخدم.",
    commonMistakes: ["Mock كل dependency ثم يصبح refactor مستحيلًا.", "استخدام fake لا يشبه failure modes الحقيقية عند الحاجة."],
    followUpQuestions: ["متى يكون real implementation مع sandbox أفضل من mock؟"],
    sources: [{ title: "Flutter docs — Mock dependencies", url: "https://docs.flutter.dev/cookbook/testing/unit/mocking" }],
    lastReviewedAt: "2026-08-30",
  },
  {
    id: "test-005",
    slug: "deterministic-and-reliable-flutter-tests",
    trackId: "flutter",
    topicIds: ["testing"],
    difficulty: "Senior",
    question: "إزاي تخلي اختبارات Flutter reliable وغير flaky؟",
    shortAnswer: "اعزل الوقت والعشوائية والشبكة، وانتظر condition واضحة بأدوات الاختبار بدل sleep، ونظّف resources وtest data بعد كل حالة.",
    explanation: "اختبار موثوق يملك environment معروفًا ويكشف failure بدل ابتلاعه. استخدم test binding وأدوات الانتظار عند الحاجة، وقلّل الاعتماد على ترتيب الاختبارات أو حالة جهاز مشتركة.",
    commonMistakes: ["إضافة delay أطول لإخفاء race condition.", "ترك singleton أو subscription من test يؤثر في التالي."],
    followUpQuestions: ["كيف تفرق بين flaky test وbug حقيقي في التطبيق؟"],
    sources: [
      { title: "Flutter docs — Testing overview", url: "https://docs.flutter.dev/testing" },
      { title: "Flutter API — WidgetTester.pumpAndSettle", url: "https://api.flutter.dev/flutter/flutter_test/WidgetTester/pumpAndSettle.html" },
    ],
    lastReviewedAt: "2026-08-30",
  },
  {
    id: "perf-001",
    slug: "profiling-before-performance-optimization",
    trackId: "flutter",
    topicIds: ["performance"],
    difficulty: "Junior",
    question: "ليه نعمل profiling قبل ما نحسّن أداء Flutter؟",
    shortAnswer: "القياس يحدد المرحلة والـdevice والـcode path المكلف بدل تخمين optimization قد لا يغيّر تجربة المستخدم.",
    explanation: "قِس في profile mode وعلى جهاز قريب من الواقع، ثم قارن baseline واضحًا مثل frame time أو memory. لا تستنتج من debug logs أو microbenchmark صغير أن التطبيق كله بطيء.",
    commonMistakes: ["تحسين كود لمجرد أنه يبدو معقدًا.", "القياس على debug ثم نشر نتيجة غير قابلة للمقارنة."],
    followUpQuestions: ["ما الفرق بين jank في build وjank في raster؟"],
    sources: [{ title: "Flutter docs — Performance profiling", url: "https://docs.flutter.dev/perf/ui-performance" }],
    lastReviewedAt: "2026-08-30",
  },
  {
    id: "perf-002",
    slug: "frame-budget-and-jank-diagnosis",
    trackId: "flutter",
    topicIds: ["performance"],
    difficulty: "Mid",
    question: "إيه معنى frame budget وإزاي تشخّص jank؟",
    shortAnswer: "كل frame له وقت محدود ليُبنى ويُرسم؛ تجاوز الميزانية يسبب تقطيعًا، ويجب تحديد إن كان السبب UI thread أو raster work.",
    explanation: "استخدم timeline وframe chart لتعرف هل العمل في build/layout/paint أم rasterization. لا تعالج كل jank بتقليل rebuild؛ الصورة أو shader أو I/O قد تكون السبب.",
    commonMistakes: ["التركيز على متوسط FPS وإخفاء spikes.", "افتراض أن عدد Widgets وحده يحدد frame time."],
    followUpQuestions: ["متى تستخدم raster stats أو performance overlay؟"],
    sources: [{ title: "Flutter docs — Performance profiling", url: "https://docs.flutter.dev/perf/ui-performance" }],
    lastReviewedAt: "2026-08-30",
  },
  {
    id: "perf-003",
    slug: "lazy-list-builders-and-large-collections",
    trackId: "flutter",
    topicIds: ["performance"],
    difficulty: "Junior",
    question: "إمتى تستخدم ListView.builder بدل بناء قائمة كاملة؟",
    shortAnswer: "builder ينشئ children عند الحاجة، فيقلل الذاكرة والعمل الأولي للقوائم الكبيرة أو غير المحدودة.",
    explanation: "استخدم itemBuilder وitemCount مع keys مستقرة عند الحاجة، وتجنب تحميل كل العناصر في Column أو ListView children دفعة واحدة. لا تستخدم lazy builder إذا كانت القائمة صغيرة وثابتة بلا مشكلة قياس.",
    commonMistakes: ["تنفيذ network أو parsing داخل itemBuilder في كل build.", "استخدام index كهوية لعناصر يمكن إعادة ترتيبها."],
    followUpQuestions: ["كيف تتعامل مع pagination وloading item؟"],
    sources: [{ title: "Flutter cookbook — Place items on demand", url: "https://docs.flutter.dev/cookbook/lists/long-lists" }],
    lastReviewedAt: "2026-08-30",
  },
  {
    id: "perf-004",
    slug: "avoiding-expensive-work-in-build",
    trackId: "flutter",
    topicIds: ["performance"],
    difficulty: "Mid",
    question: "إزاي تمنع expensive work داخل build؟",
    shortAnswer: "احسب أو حمّل البيانات خارج build، استخدم memoization أو state مناسبة، وقلّل subtree الذي يعاد بناؤه بدل إخفاء العمل في helper.",
    explanation: "build قد تتكرر أكثر مما تتوقع، لذلك لا تضع sort كبيرًا أو JSON parsing أو I/O داخلها. انقل العمل إلى repository أو controller، ثم قِس قبل إضافة cache حتى لا تخزن بيانات بلا فائدة.",
    commonMistakes: ["تسمية function بـget ثم تنفيذ network داخلها أثناء build.", "إضافة cache عالمي قبل معرفة تكلفة العمل."],
    followUpQuestions: ["متى يكون Selector أو child subtree مفيدًا؟"],
    sources: [{ title: "Flutter docs — Performance best practices", url: "https://docs.flutter.dev/perf/best-practices" }],
    lastReviewedAt: "2026-08-30",
  },
  {
    id: "perf-005",
    slug: "image-memory-and-render-cost",
    trackId: "flutter",
    topicIds: ["performance"],
    difficulty: "Senior",
    question: "إزاي تفسر مشاكل أداء الصور والذاكرة في Flutter؟",
    shortAnswer: "افصل حجم الملف عن حجم الصورة المفكوكة في الذاكرة، واستخدم caching وresize مناسبين للعرض بدل تحميل أصل ضخم لكل device.",
    explanation: "راقب memory وraster time عند عرض صور كثيرة، وحدد cache policy وlifecycle. تحسين جودة الصورة أو ضغطها لا يكفي إذا كان decode dimensions أكبر بكثير من مكانها على الشاشة.",
    commonMistakes: ["اعتبار ملف JPEG صغيرًا يعني استهلاك ذاكرة صغير.", "إزالة كل caching ثم إعادة تنزيل الصور في كل rebuild."],
    followUpQuestions: ["متى تستخدم cacheWidth أو thumbnails؟"],
    sources: [
      { title: "Flutter docs — Performance best practices", url: "https://docs.flutter.dev/perf/best-practices" },
      { title: "Flutter API — Image constructor", url: "https://api.flutter.dev/flutter/widgets/Image/Image.html" },
      { title: "Flutter API — ResizeImage", url: "https://api.flutter.dev/flutter/painting/ResizeImage-class.html" },
    ],
    lastReviewedAt: "2026-08-30",
  },
  {
    id: "async-001",
    slug: "dart-event-loop-and-microtasks",
    trackId: "flutter",
    topicIds: ["async-isolates"],
    difficulty: "Mid",
    question: "إزاي يشتغل Dart event loop والفرق بين microtask وevent queue؟",
    shortAnswer: "isolate يعالج microtask queue قبل event queue؛ الإفراط في microtasks أو عمل CPU متواصل قد يمنع events ويفسد استجابة UI.",
    explanation: "Future callbacks وtimers تُجدول بدل تنفيذها فورًا في نفس stack، لكن scheduling لا يجعل العمل CPU-bound مجانيًا. افهم ترتيب التسجيل والـqueues قبل تفسير race أو frame delay.",
    commonMistakes: ["اعتبار async/await thread جديدًا.", "إضافة microtask loop طويل ثم الاستغراب من توقف input."],
    followUpQuestions: ["متى ينفذ Timer مقارنة بـFuture.microtask؟"],
    sources: [{ title: "Dart docs — Concurrency", url: "https://dart.dev/language/concurrency" }],
    lastReviewedAt: "2026-08-30",
  },
  {
    id: "async-003",
    slug: "streams-and-multiple-async-values",
    trackId: "flutter",
    topicIds: ["async-isolates"],
    difficulty: "Mid",
    question: "إمتى تستخدم Stream بدل Future؟",
    shortAnswer: "Future تعيد قيمة واحدة، بينما Stream تمثل sequence من القيم أو الأحداث مع إمكانية error وdone.",
    explanation: "اختر Stream للـsocket أو user events أو progress متعدد، وأدر subscription وcancel أو استخدم StreamBuilder بوضوح. لا تحول request واحدة إلى Stream بلا احتياج لتعدد القيم.",
    commonMistakes: ["إنشاء stream داخل build ثم الاشتراك مرارًا.", "نسيان close أو cancel لمصدر stream مملوك للـfeature."],
    followUpQuestions: ["كيف تتعامل مع backpressure أو event سريع؟"],
    sources: [{ title: "Dart API — Stream", url: "https://api.dart.dev/dart-async/Stream-class.html" }],
    lastReviewedAt: "2026-08-30",
  },
  {
    id: "async-004",
    slug: "isolates-for-cpu-bound-work",
    trackId: "flutter",
    topicIds: ["async-isolates"],
    difficulty: "Senior",
    question: "متى تنقل CPU-bound work إلى isolate؟",
    shortAnswer: "انقل parsing أو compression أو خوارزمية ثقيلة إلى isolate عندما تثبت أنها تحجب UI isolate، وتبادل رسائل أو نتائج قابلة للنقل.",
    explanation: "isolate يملك memory وevent loop منفصلين، لذلك لا تشارك mutable state مباشرة. ابدأ بقياس frame impact، واستخدم compute أو Isolate.run للحالات المناسبة على native؛ في Flutter Web قد يعمل compute على event loop الحالي، وتجنب تكلفة spawn لعمل صغير.",
    commonMistakes: ["استخدام isolate لكل Future صغير.", "افتراض أن timeout يلغي compute أو Isolate.run؛ الإلغاء الحقيقي يحتاج isolate مملوكًا يمكن إيقافه."],
    followUpQuestions: ["ما تكلفة إنشاء isolate ومتى تفضل worker طويل العمر؟"],
